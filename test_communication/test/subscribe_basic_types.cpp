...
rclcpp::SubscriptionBase::SharedPtr subscribe_basic_types(
    ...
    std::vector<bool>& received_messages) {
  return subscribe<test_msgs::msg::BasicTypes>(node, message_type, messages_expected, received_messages);
}
...
rclcpp::SubscriptionBase::SharedPtr subscribe_builtins(
    ...
    std::vector<bool>& received_messages) {
  return subscribe<test_msgs::msg::Builtins>(node, message_type, messages_expected, received_messages);
}
...
rclcpp::SubscriptionBase::SharedPtr subscribe_constants(
    ...
    std::vector<bool>& received_messages) {
  return subscribe<test_msgs::msg::Constants>(node, message_type, messages_expected, received_messages);
}
...
rclcpp::SubscriptionBase::SharedPtr subscribe_defaults(
    ...
    std::vector<bool>& received_messages) {
  return subscribe<test_msgs::msg::Defaults>(node, message_type, messages_expected, received_messages);
}
